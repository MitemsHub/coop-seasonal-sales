...
// Catches runtime errors within the admin shell and shows a recovery UI
// that keeps the admin in the admin context (not dumped to a generic page).
  ...
  return (
    <div className="flex min-h-[50vh] items-center justify-center px-4">
      <div className="w-full max-w-md text-center">
        ...
        <h1 className="text-xl font-bold text-fg">Admin panel error</h1>
        <p className="mt-2 text-sm leading-6 text-muted">
          This admin page encountered an error. You can try reloading it or
