// app/api/rep/ram/orders/audit/route.js
// GET /api/rep/ram/orders/audit?order_id=NNN
...
// (rows tagged module='ram', order_id = String(ram_orders.id)). Scoped to the
// rep's delivery locations so a rep can only inspect their own orders.
