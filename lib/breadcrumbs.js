...
const VENDOR_ROUTES = [
  ...
  {
    test: (p) => p === '/vendor/reports',
    trail: () => [crumb('Vendor Portal', '/vendor/dashboard'), crumb('Report')],
  },
]
...
const STAFF_PAGES = {
  admin: {
    ...
    exhibition: ['pending', 'approved', 'delivered', 'cancelled', 'cycles', 'vendors', 'products', 'markups', 'banks', 'data', 'reports', 'audit'],
  },
  rep: {
